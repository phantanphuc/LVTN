...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Việc trích đặc trưng của mạng SSD\footfullcite{liu2016ssd} được thực hiện bởi một mạng cơ sở.
			\item 	Mạng cơ sở của SSD là một mạng nơron tích chập bất kỳ, có thể là VGG\footfullcite{Simonyan14c} hoặc lenet\footfullcite{yanlecun},... 
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Mạng SSD xây dựng các lớp tích chập, trong đó có lớp có stride bằng 2, giúp tạo các feature map có kích thước theo một cấp số nhân.
		\end{itemize}
