...
\begin{document}
	...
	\begin{frame}{Phạm vi đề tài}
		\begin{itemize}
			...
			\uncover<3->{\item Mỗi ảnh dùng để nhận dạng chỉ chứa đúng 1 biểu thức và biểu thức này có đường cơ sở\footnote{Thuật ngữ tiếng Anh: baseline} không bị lệch khỏi đường nằm ngang của ảnh.}
