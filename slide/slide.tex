...
\begin{document}
	...
	\begin{frame}
		...
		SSD\footfullcite{liu2016ssd} sinh ra một số lượng hữu hạn các \textbf{default box} được xem là các "hệ quy chiếu" để hệ thống có thể xác định vị trí và kích thước các ký tự cần nhận diện. Thông qua quá trình huấn luyện, mạng cần phải học cách dự đoán các \textbf{bounding box} bọc quanh ký tự cần nhận diện thông qua "hệ quy chiếu" tương ứng bên trên.
		
		SSD\footfullcite{liu2016ssd} sử dụng các lớp tích chập (hay cụ thể hơn là mạng nơ-ron tích chập) để trích đặc trưng, tạo tiền đề cho việc phát hiện và phân loại ký tự. \\
	...
	\begin{frame}
		...
		\begin{center}
			...
			\captionof{figure}{Tại mỗi vị trí, nhiều default box được sinh ra với tỉ lệ kích thước khác nhau}
		\end{center}
	...
	\begin{frame}
		...
		\begin{center}
			\centering
			\includegraphics[width=0.5\linewidth]{GT_BB.png}
			\vspace{0.5cm}
	...
	\begin{frame}
		...
		\begin{center}
			\centering
			\includegraphics[width=0.5\linewidth]{GT_Ja.png}
			\captionof{figure}{Chỉ số Jaccard \footfullcite{Jaccard}}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\centering
			\includegraphics[width=0.5\linewidth]{GTM.png}
			\vspace{0.5cm}
			\captionof{figure}{Quá trình matching}
		\end{center}
	\end{frame}
	\begin{frame}
		...
		\begin{center}
			\centering
			\includegraphics[width=0.5\linewidth]{GTDoneMatch.png}
			\vspace{0.5cm}
			\captionof{figure}{Quá trình matching}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		Mạng cơ sở của SSD\footfullcite{liu2016ssd} là một mạng nơron tích chập bất kỳ, có thể là VGG\cite{Simonyan14c} hoặc lenet\cite{yanlecun},... \\
		Khi kết hợp với mạng SSD\footfullcite{liu2016ssd}, các lớp liên kết đầy đủ của mạng nơ-ron tích chập sẽ được thay thế bằng các lớp tích chập khác và song hành là các bước trích feature map để dự đoán vị trí, kích thước của các ký tự.
	...
	\begin{frame}
		...
		\begin{center}
			\centering
			\includegraphics[width=0.95\linewidth]{SSD_Struture_3.png}
			\vspace{0.5cm}
			\captionof{figure}{Mô hình mạng SSD nguyên thủy}
		\end{center}
	...
	\begin{frame}
		...
		\begin{center}
			\centering
			\includegraphics[width=0.40\linewidth]{im_4.png}
	...
	\begin{frame}
		\frametitle{Phân tích cấu trúc}
		Bộ phận phân tích cấu trúc có nhiệm vụ nhận dữ liệu là các bounding box từ SSD\footfullcite{liu2016ssd} và xây dựng một cây Lex - BST\footfullcite{zanibbi} tạo tiền đề để xây dựng biểu thức Latex.
	\end{frame}
	...
	\begin{frame}{Đánh giá định tính}
		\begin{center}
			...
			\vspace{0.5cm}
			\captionof{figure}{Một số ảnh kết quả sau quá trình nhận dạng.}
		\end{center}
	\end{frame}
