...
%	\end{frame}
	...
	\begin{block}{}
		...
		Khi kích thước feature map tăng lên, số lượng default box tương ứng với feature map đó cũng tăng lên, lấp đầy phần lưới bị hổng.
	\end{block}
	\end{frame}
	...
	\begin{block}{Các thay đổi}
		\begin{itemize}
			\item Tăng thêm một khối gồm 02 lớp convolutoin nhầm tăng số feature map trích xuất được.
		\end{itemize}
